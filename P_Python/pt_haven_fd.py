...
def main():
    ...
    ax1.plot(dt_pd_fin[['log.XAU']], color='blue', label='XAU Log-Returns')
    ax1.legend(loc='upper left')
    ax2.plot(dt_pd_fin[['log.Global.Govt']], color='blue', label='GA Treasuries Log-Returns')
    ...
    plt.savefig('pt_haven_log_ret.pdf')
