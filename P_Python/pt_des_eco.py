...
def main():
    ...
    dt_pd_aggr = pd.read_pickle('dt_pd_bitcoin_economy.pickle')
    ...
    p1, = host.plot(dt_pd_aggr.index, dt_pd_aggr['new_users'], "b-", label="New Users")
    p2, = par1.plot(dt_pd_aggr.index, dt_pd_aggr['new_transactions'], "r-", label="New Transactions")
    p3, = par2.plot(dt_pd_aggr.index, dt_pd_aggr['new_curr_transacted'], "g-", label="Transaction Value")
    ...
    plt.savefig('pt_des_eco-z.pdf') # bbox_inches='tight'
